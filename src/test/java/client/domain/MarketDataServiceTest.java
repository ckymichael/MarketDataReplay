...
class MarketDataServiceTest {
    ...
    void getHighestPriceMovement() {
        ...
        assertEquals(priceMove.getPriceMovementInPercent(), trade5.calculatePriceMovementInPercent(price1));
    }
    ...
    void getLowestPriceMovement() {
        ...
        assertEquals(priceMove.getPriceMovementInPercent(), trade4.calculatePriceMovementInPercent(price4));
    }
